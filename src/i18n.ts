...
export const UI = {
  de: {
    ...
    hero: {
      ...
      text: 'Ich verbinde Musik, Marketing, Business Administration und kreative Umsetzung. Auf dieser Website zeige ich ausgewählte Arbeiten, Erfahrungen und Studienprojekte, die meine praktische Entwicklung in der Musik- und Kreativbranche dokumentieren.',
    ...
    positioning: {
      title: 'Was ich mache',
      text: 'Ich unterstütze Künstler:innen, Musikprojekte und kreative Organisationen bei Social Media Marketing, Content-Strategie, Artist Management, Organisation und Markenkommunikation.',
      cards: [
    ...
    skills: {
      ...
      groups: [
        ...
        { title: 'Web & CMS', items: ['WordPress', 'Webflow', 'Framer', 'Astro'] },
      ],
    },
    about: {
      title: 'Aus der italienischen Schweiz nach Berlin',
      text: 'Ich bin musikbegeistert und habe mich bewusst entschieden, praktische Erfahrungen in der Musik- und Kreativbranche zu sammeln. Mein Hintergrund verbindet Business Administration, Social Media, Organisation und kreative Umsetzung. Diese Website zeigt nicht nur, wo ich gearbeitet habe, sondern was ich dort konkret umgesetzt und gelernt habe.',
    },
    contact: {
      title: 'Lass uns sprechen',
      text: 'Für Praktika, Musikprojekte, kreative Zusammenarbeit oder berufliche Möglichkeiten freue ich mich über eine Kontaktaufnahme.',
  ...
  it: {
    ...
    hero: {
      ...
      title: 'Luca Invernizzi',
      subtitle: 'Music Marketing, Artist Management & Creative Operations',
      text: 'Unisco musica, marketing, business administration e realizzazione creativa. Questo sito raccoglie lavori selezionati, esperienze e progetti di studio che documentano il mio percorso pratico nella musica e nell’industria creativa.',
    ...
    positioning: {
      title: 'Cosa faccio',
      text: 'Supporto artisti, progetti musicali e organizzazioni creative in social media marketing, content strategy, artist management, organizzazione e comunicazione di marca.',
      cards: [
  ...
  en: {
    ...
    hero: {
      ...
      title: 'Luca Invernizzi',
      subtitle: 'Music Marketing, Artist Management & Creative Operations',
      text: 'I connect music, marketing, business administration and creative execution. This site presents selected work, experiences and study projects that document my practical development in music and the creative industry.',
      primary: 'View work',
    ...
    positioning: {
      title: 'What I do',
      text: 'I support artists, music projects and creative organisations with social media marketing, content strategy, artist management, organisation and brand communication.',
      cards: [
